...
function OrstraxProductBrand({
  ...
  const content = /* @__PURE__ */ jsxRuntime.jsxs("span", { className: `orstrax-lockup orstrax-lockup--${size} ${className}`.trim(), children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx("span", { className: `orstrax-lockup-name ${toneClass}`.trim(), children: productName })
  ] });
  if (href) {
...
function OrstraxAppShell({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "desk-app min-h-screen", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex min-w-0 flex-1 flex-col", children: [
      /* @__PURE__ */ jsxRuntime.jsxs("header", { className: "orstrax-topbar", children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          "button",
          {
            type: "button",
        ...
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "hidden min-w-0 md:block", children: /* @__PURE__ */ jsxRuntime.jsx(OrstraxProductBrand, { productName, size: "sm", LinkComponent }) }),
