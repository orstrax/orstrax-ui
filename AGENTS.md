...
This repo **is** the source of truth for hosted theme, family X, wordmark, mark, and cross-product standards.
...
- Changing `public/assets/orstrax-x.png`, `orstrax-wordmark.png`, or a promoted theme version requires updating the canonical standards if paths/versions change.
- Product lockup is `[hosted X] + [product name]`. Do not typeset the X or put “Orstrax” beside it.
...
SHARED UI:            this repo hosts it; pinned consumer version v1.0.9
EMAIL:                none
